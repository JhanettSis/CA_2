...
public class InsertUserStaff {
    ...
    public static void InserStaff(Scanner scanner, String fileName) {
        ...
        String staffName;
        while (true) {
            System.out.print("Please input the Player Name: "); // Prompt user for name
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName, true))) {
            ...
            System.out.println('"' + staffName + "\" has been added as \"" + selectedRole + "\" to \"" + selectedDepartment + "\" successfully!");
